...
**hello-rails-backend:** is a hello world project using rails and react.

[Link to Front-end](https://github.com/prg-04/hello-react-frontend/tree/feature/setup)
...
```sh
  git clone https://github.com/prg-04/hello-rails-backend.git
```
...
Feel free to check the [issues page](https://github.com/prg-04/hello-rails-backend/issues).
